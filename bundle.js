...
/* harmony import */ var _models_movie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/movie */ "./src/models/movie.js");
...
class API {
  ...
  getMovies() {
    return this._load({url: `movies`})
      ...
      .then(_models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovies);
  }
  ...
  updateMovie(id, movie) {
    return this._load({
      ...
      .then((response) => response.json())
      .then(_models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie);
  }
  ...
  getComments(movies) {
    const promises = movies.map((movie) => {
      return this._load({url: `comments/${movie.id}`})
        .then((response) => response.json())
        .then(_models_comment__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments);
    });
  ...
  createComment(id, comment) {
    return this._load({
      ...
      .then((response) => response.json())
      .then((comments) => {
        const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_0__["default"].parseMovie(comments[`movie`]);
        const newComments = _models_comment__WEBPACK_IMPORTED_MODULE_1__["default"].parseComments(comments[`comments`]);
...
/* harmony import */ var _util_dom_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/dom-util */ "./src/util/dom-util.js");
...
class AbstractComponent {
  ...
  getElement() {
    if (!this._element) {
      this._element = Object(_util_dom_util__WEBPACK_IMPORTED_MODULE_0__["createElement"])(this.getTemplate());
    }
...
class ChartData {
  static create(genres, moviesByGenres) {
    return (
      {
        plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_0___default.a],
        type: CHART.TYPE,
        data: {
          labels: genres,
          datasets: [{
...
/***/ "./src/components/films/button-show-more.js":
/*!**************************************************!*\
  !*** ./src/components/films/button-show-more.js ***!
  \**************************************************/
/*! exports provided: default */
...
class ButtonShowMore extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
/***/ "./src/components/films/film-card.js":
/*!*******************************************!*\
  !*** ./src/components/films/film-card.js ***!
  \*******************************************/
/*! exports provided: default */
...
class FilmCard extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(movie) {
    super();
    this._movie = movie;
  }
    ...
    return (
      `<article class="film-card">
        ...
        <p class="film-card__info">
          <span class="film-card__year">${moment__WEBPACK_IMPORTED_MODULE_1___default()(this._movie.release).year()}</span>
          <span class="film-card__duration">${Object(_util_util__WEBPACK_IMPORTED_MODULE_2__["getDuration"])(this._movie.runtime)}</span>
        ...
        <a class="film-card__comments">${this._movie.comments.length} ${Object(_util_util__WEBPACK_IMPORTED_MODULE_2__["pluralize"])(this._movie.comments.length, [`Comment`, `Comments`])}</a>
...
/***/ "./src/components/films/film-details.js":
/*!**********************************************!*\
  !*** ./src/components/films/film-details.js ***!
  \**********************************************/
/*! exports provided: default */
...
/* harmony import */ var _util_dom_util__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../util/dom-util */ "./src/util/dom-util.js");
/* harmony import */ var _util_consts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../util/consts */ "./src/util/consts.js");
...
class FilmDetails extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getNewComment() {
    ...
    const newComment = Object(he__WEBPACK_IMPORTED_MODULE_1__["encode"])(this.getElement().querySelector(`.film-details__comment-input`).value);
  ...
  shake() {
    this.getElement().style.animation = `shake ${_util_consts__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"] / _util_consts__WEBPACK_IMPORTED_MODULE_5__["MILLISECONDS_COUNT"]}s`;

    setTimeout(() => {
      this._resetShaking();
    }, _util_consts__WEBPACK_IMPORTED_MODULE_5__["SHAKE_ANIMATION_TIMEOUT"]);
  }
      ...
      `<li class="film-details__comment" data-comment-id="${id}">
          ...
          <div>
            ...
            <p class="film-details__comment-info">
              ...
              <span class="film-details__comment-day">${moment__WEBPACK_IMPORTED_MODULE_2___default()(date).fromNow()}</span>
  ...
  _getMovieDetails() {
    const movieDetails = [
      ...
      {
        name: Object(_util_util__WEBPACK_IMPORTED_MODULE_3__["pluralize"])(this._movie.writers.length, [`Writer`, `Writers`]),
        value: this._movie.writers
      },
      {
        name: Object(_util_util__WEBPACK_IMPORTED_MODULE_3__["pluralize"])(this._movie.actors.length, [`Actor`, `Actors`]),
        value: this._movie.actors.join(`, `)
      },
      {
        name: `Release`,
        value: Object(_util_util__WEBPACK_IMPORTED_MODULE_3__["getFullDate"])(this._movie.release)
      },
      {
        name: `Runtime`,
        value: Object(_util_util__WEBPACK_IMPORTED_MODULE_3__["getDuration"])(this._movie.runtime)
      },
      {
        name: `Country`,
      ...
      {
        name: Object(_util_util__WEBPACK_IMPORTED_MODULE_3__["pluralize"])(this._movie.genres.length, [`Genre`, `Genres`]),
  ...
  _onEmojiClickListener(evt) {
    ...
    emojiContainer.appendChild(Object(_util_dom_util__WEBPACK_IMPORTED_MODULE_4__["createElement"])(this._getCurrentEmojiMarkup()));
  }
}
...
/***/ "./src/components/films/films-list-extra.js":
/*!**************************************************!*\
  !*** ./src/components/films/films-list-extra.js ***!
  \**************************************************/
/*! exports provided: default */
...
class FilmsListExtra extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(title) {
    super();
    this._title = title;
...
/***/ "./src/components/films/films-list.js":
/*!********************************************!*\
  !*** ./src/components/films/films-list.js ***!
  \********************************************/
/*! exports provided: default */
...
class FilmsList extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/***/ "./src/components/films/no-movies.js":
/*!*******************************************!*\
  !*** ./src/components/films/no-movies.js ***!
  \*******************************************/
/*! exports provided: default */
...
class NoMovies extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
      `<section class="films-list">
...
/* harmony import */ var _abstract_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-component */ "./src/components/abstract-component.js");
/* harmony import */ var _util_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/filter */ "./src/util/filter.js");
...
class Filter extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _showCount(type, count) {
    if (type !== _util_filter__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL) {
      return (
...
class Footer extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
...
class Header extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
      `<header class="header">
...
class Loading extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
      `<section class="films">
        <section class="films-list">
...
class Main extends _abstract_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
class Sort extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
/* harmony import */ var _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract-smart-component */ "./src/components/abstract-smart-component.js");
/* harmony import */ var _chart_data__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./chart-data */ "./src/components/chart-data.js");
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! chart.js */ "./node_modules/chart.js/dist/Chart.js");
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(chart_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _user_rank__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./user-rank */ "./src/components/user-rank.js");
/* harmony import */ var _util_filter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../util/filter */ "./src/util/filter.js");
/* harmony import */ var _util_consts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../util/consts */ "./src/util/consts.js");
...
const DEFAULT_FILTER = _util_filter__WEBPACK_IMPORTED_MODULE_4__["StatsFilterType"].ALL;
const SERVER_URL = `https://echo.htmlacademy.ru/`;

class Statistics extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    const movies = Object(_util_filter__WEBPACK_IMPORTED_MODULE_4__["getMoviesByFilter"])(this._moviesModel.movies, this._filter);
    ...
    const userRank = Object(_user_rank__WEBPACK_IMPORTED_MODULE_3__["getUserRank"])(this._moviesModel.getAllMovies());
  ...
  _getTotalMovieDuration(movies) {
    ...
    totalDuration.hours = Math.floor(totalMovieDuration / _util_consts__WEBPACK_IMPORTED_MODULE_5__["MINUTES_IN_HOUR"]);
    totalDuration.minutes = totalMovieDuration % _util_consts__WEBPACK_IMPORTED_MODULE_5__["MINUTES_IN_HOUR"];
  ...
  _renderChart(movies) {
    movies = Object(_util_filter__WEBPACK_IMPORTED_MODULE_4__["getMoviesByFilter"])(movies, this._filter);
    const watchedMovies = this._getWatchedMovies(movies);
    const moviesByGenres = this._getMoviesAmountByGenre(watchedMovies);
    const genres = moviesByGenres.map((movie) => movie.genre);

    const chartData = _chart_data__WEBPACK_IMPORTED_MODULE_1__["default"].create(genres, moviesByGenres);

    return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(this._getGenresCtx(), chartData);
  }
...
/***/ "./src/components/user-rank.js":
/*!*************************************!*\
  !*** ./src/components/user-rank.js ***!
  \*************************************/
/*! exports provided: default, getUserRank */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
class UserRank extends _abstract_smart_component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(moviesModel) {
    super();
...
/* harmony import */ var _components_filter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/filter */ "./src/components/filter.js");
/* harmony import */ var _util_filter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util/filter */ "./src/util/filter.js");
/* harmony import */ var _util_dom_util__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../util/dom-util */ "./src/util/dom-util.js");
/* harmony import */ var _util_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../util/util */ "./src/util/util.js");
...
class FilterController {
  constructor(container, moviesModel) {
    ...
    this._activeFilterType = _util_filter__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL;
  ...
  render() {
    ...
    this._filterComponent = new _components_filter__WEBPACK_IMPORTED_MODULE_0__["default"](filters, menuItems);
    this._filterComponent.setFilterChangeListener(this._onFilterChange);

    if (oldComponent) {
      Object(_util_dom_util__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._filterComponent, oldComponent);
  ...
  _createFilters(movies) {
    return Object.values(_util_filter__WEBPACK_IMPORTED_MODULE_1__["FilterType"]).map((filterType) => {
      return {
        type: filterType,
        name: _util_filter__WEBPACK_IMPORTED_MODULE_1__["FilterNames"][filterType.toUpperCase()],
        count: Object(_util_filter__WEBPACK_IMPORTED_MODULE_1__["getMoviesByFilter"])(movies, filterType).length,
  ...
  _createMenuItems() {
    return Object.values(_util_filter__WEBPACK_IMPORTED_MODULE_1__["MenuType"]).map((menuType) => {
      return {
        type: menuType,
        name: Object(_util_util__WEBPACK_IMPORTED_MODULE_3__["capitalize"])(menuType),
...
/* harmony import */ var _components_films_film_details__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/films/film-details */ "./src/components/films/film-details.js");
/* harmony import */ var _components_films_film_card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/films/film-card */ "./src/components/films/film-card.js");
/* harmony import */ var _models_movie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../models/movie */ "./src/models/movie.js");
/* harmony import */ var _util_dom_util__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../util/dom-util */ "./src/util/dom-util.js");
...
class MovieController {
  ...
  render(movie, comments) {
    ...
    this._filmCardComponent = new _components_films_film_card__WEBPACK_IMPORTED_MODULE_1__["default"](movie);
    this._filmDetailsComponent = new _components_films_film_details__WEBPACK_IMPORTED_MODULE_0__["default"](movie, comments);

    this._setFilmCardsListeners(movie);
    this._setFilmDetailsListeners(movie);

    if (oldFilmDetailsComponent && oldFilmCardComponent) {
      Object(_util_dom_util__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._filmCardComponent, oldFilmCardComponent);
      Object(_util_dom_util__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._filmDetailsComponent, oldFilmDetailsComponent);
    } else {
  ...
  _setFilmCardsListeners(movie) {
    ...
    this._filmCardComponent.setAddToWatchlistClickListener(() => {
      const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_2__["default"].clone(movie);
  ...
  _closeFilmDetails() {
    ...
    const newMovie = _models_movie__WEBPACK_IMPORTED_MODULE_2__["default"].clone(this._movie);
  ...
  _onEscKeyDown(evt) {
    if (Object(_util_util__WEBPACK_IMPORTED_MODULE_4__["isEscKey"])(evt)) {
      this._closeFilmDetails();
    }
  }
}
...
/* harmony import */ var _components_films_button_show_more__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../components/films/button-show-more */ "./src/components/films/button-show-more.js");
/* harmony import */ var _components_films_films_list__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../components/films/films-list */ "./src/components/films/films-list.js");
/* harmony import */ var _components_films_films_list_extra__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/films/films-list-extra */ "./src/components/films/films-list-extra.js");
/* harmony import */ var _movie_controller__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./movie-controller */ "./src/controllers/movie-controller.js");
/* harmony import */ var _components_films_no_movies__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/films/no-movies */ "./src/components/films/no-movies.js");
...
/* harmony import */ var _util_consts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../util/consts */ "./src/util/consts.js");
...
class PageController {
  constructor(filmsComponent, sortComponent, moviesModel, commentsModel, api) {
    ...
    this._shownMoviesTotal = _util_consts__WEBPACK_IMPORTED_MODULE_7__["QUANTITY_MOVIES"].ON_START;
    this._noMoviesComponent = new _components_films_no_movies__WEBPACK_IMPORTED_MODULE_4__["default"]();


    this._filmsListComponent = new _components_films_films_list__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._filmsList = this._filmsListComponent.getElement();
    this._filmsListContainer = this._filmsListComponent.filmsListElement;

    this._buttonShowMore = new _components_films_button_show_more__WEBPACK_IMPORTED_MODULE_0__["default"]();

    this._filmsListTopRatedComponent = new _components_films_films_list_extra__WEBPACK_IMPORTED_MODULE_2__["default"](SECTIONS.RATING);
    this._filmsListMostCommentedComponent = new _components_films_films_list_extra__WEBPACK_IMPORTED_MODULE_2__["default"](SECTIONS.COMMENTS);
  ...
  _renderMovieCards(container, movies, onDataChange, onViewChange) {
    return movies.map((movie) => {
      const movieController = new _movie_controller__WEBPACK_IMPORTED_MODULE_3__["default"](container, onDataChange, onViewChange, this._commentsModel, this._api);
  ...
  _getSortedMovies(movies, sortType, from, to) {
    ...
    switch (sortType) {
      case _components_sort__WEBPACK_IMPORTED_MODULE_6__["SortType"].DATE:
        sortedMovies = shownMovies.sort((a, b) => Object(_util_util__WEBPACK_IMPORTED_MODULE_5__["getDateFromString"])(b.release) - Object(_util_util__WEBPACK_IMPORTED_MODULE_5__["getDateFromString"])(a.release));
        break;
      case _components_sort__WEBPACK_IMPORTED_MODULE_6__["SortType"].RATING:
        sortedMovies = shownMovies.sort((a, b) => b.rating - a.rating);
        break;
      case _components_sort__WEBPACK_IMPORTED_MODULE_6__["SortType"].DEFAULT:
    ...
    this._api.updateMovie(oldMovie.id, newMovie)
      .then((movie) => {
        ...
        if (isSuccess) {
          ...
          if (mode === _movie_controller__WEBPACK_IMPORTED_MODULE_3__["Mode"].DETAILS || isAllMoviesShown) {
            this._shownControllers
  ...
  _onButtonShowMoreClick() {
    ...
    this._shownMoviesTotal = this._shownMoviesTotal + _util_consts__WEBPACK_IMPORTED_MODULE_7__["QUANTITY_MOVIES"].BY_BUTTON;
...
/* harmony import */ var _models_comments__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/comments */ "./src/models/comments.js");
/* harmony import */ var _components_films_films__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/films/films */ "./src/components/films/films.js");
...
/* harmony import */ var _models_movies__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./models/movies */ "./src/models/movies.js");
/* harmony import */ var _controllers_page_controller__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./controllers/page-controller */ "./src/controllers/page-controller.js");
/* harmony import */ var _components_sort__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/sort */ "./src/components/sort.js");
...
/* harmony import */ var _components_statistics__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/statistics */ "./src/components/statistics.js");
/* harmony import */ var _components_user_rank__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./components/user-rank */ "./src/components/user-rank.js");
/* harmony import */ var _util_filter__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./util/filter */ "./src/util/filter.js");
...
const moviesModel = new _models_movies__WEBPACK_IMPORTED_MODULE_7__["default"]();
const commentsModel = new _models_comments__WEBPACK_IMPORTED_MODULE_2__["default"]();

const headerComponent = new _components_header_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
headerComponent.render(document.body);

const mainComponent = new _components_main__WEBPACK_IMPORTED_MODULE_6__["default"]();
mainComponent.render(document.body);

const userRankComponent = new _components_user_rank__WEBPACK_IMPORTED_MODULE_12__["default"](moviesModel);

const filterController = new _controllers_filter_controller__WEBPACK_IMPORTED_MODULE_4__["default"](mainComponent.getElement(), moviesModel);
filterController.render();

const sortComponent = new _components_sort__WEBPACK_IMPORTED_MODULE_9__["default"]();
sortComponent.render(mainComponent.getElement());

const loadingComponent = new _components_loading__WEBPACK_IMPORTED_MODULE_5__["default"]();
loadingComponent.render(mainComponent.getElement());

const filmsComponent = new _components_films_films__WEBPACK_IMPORTED_MODULE_3__["default"]();
const pageController = new _controllers_page_controller__WEBPACK_IMPORTED_MODULE_8__["default"](filmsComponent, sortComponent, moviesModel, commentsModel, api);

filmsComponent.render(mainComponent.getElement());

const statisticsComponent = new _components_statistics__WEBPACK_IMPORTED_MODULE_11__["default"](moviesModel);
...
api.getMovies()
  .then((movies) => {
    ...
    const footerComponent = new _components_footer__WEBPACK_IMPORTED_MODULE_10__["default"](moviesModel.movies.length);
...
filterController.setOnMenuItemClick((menuItem) => {
  if (menuItem === _util_filter__WEBPACK_IMPORTED_MODULE_13__["MenuType"].STATS) {
    filmsComponent.hide();
    sortComponent.hide();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CommentsModel; });
class CommentsModel {
  constructor() {
    this._comments = [];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MoviesModel; });
/* harmony import */ var _util_filter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../util/filter */ "./src/util/filter.js");
...
class MoviesModel {
  constructor() {
    ...
    this._activeFilterType = _util_filter__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL;
  ...
  get movies() {
    return Object(_util_filter__WEBPACK_IMPORTED_MODULE_0__["getMoviesByFilter"])(this._movies, this._activeFilterType);
  }
...
/*!****************************!*\
  !*** ./src/util/consts.js ***!
  \****************************/
/*! exports provided: QUANTITY_MOVIES, BUTTON, MINUTES_IN_HOUR, SHAKE_ANIMATION_TIMEOUT, MILLISECONDS_COUNT */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QUANTITY_MOVIES", function() { return QUANTITY_MOVIES; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "MILLISECONDS_COUNT", function() { return MILLISECONDS_COUNT; });
...
/***/ "./src/util/dom-util.js":
/*!******************************!*\
  !*** ./src/util/dom-util.js ***!
  \******************************/
/*! exports provided: createElement, replace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/util/filter.js ***!
  \****************************/
/*! exports provided: FilterType, MenuType, FilterNames, StatsFilterType, getMoviesByFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatsFilterType", function() { return StatsFilterType; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getMoviesByFilter", function() { return getMoviesByFilter; });
...
const StatsFilter = {
  ALL: (movie) => movie,
  TODAY: (movie) => moment__WEBPACK_IMPORTED_MODULE_0___default()(movie.watchingDate).isSame(moment__WEBPACK_IMPORTED_MODULE_0___default()(), `day`),
  WEEK: (movie) => moment__WEBPACK_IMPORTED_MODULE_0___default()(movie.watchingDate).isAfter(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(7, `days`)),
  MONTH: (movie) => moment__WEBPACK_IMPORTED_MODULE_0___default()(movie.watchingDate).isAfter(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(1, `months`)),
  YEAR: (movie) => moment__WEBPACK_IMPORTED_MODULE_0___default()(movie.watchingDate).isAfter(moment__WEBPACK_IMPORTED_MODULE_0___default()().subtract(1, `years`))
};
...
/*!**************************!*\
  !*** ./src/util/util.js ***!
  \**************************/
/*! exports provided: pluralize, getDateFromString, getFullDate, getDuration, capitalize, isEscKey */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _consts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./consts */ "./src/util/consts.js");
...
const getFullDate = (date) => {
  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).format(`D MMMM YYYY`);
};

const getDuration = (timeInMinutes) => {
  return timeInMinutes >= _consts__WEBPACK_IMPORTED_MODULE_1__["MINUTES_IN_HOUR"]
    ? moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(timeInMinutes, `minutes`).asMilliseconds()).format(`h[h] mm[m]`)
    : `${timeInMinutes}m`;
};
...
const isEscKey = (evt) => {
  return evt.key === _consts__WEBPACK_IMPORTED_MODULE_1__["BUTTON"].ESCAPE || evt.key === _consts__WEBPACK_IMPORTED_MODULE_1__["BUTTON"].ESC;
};
